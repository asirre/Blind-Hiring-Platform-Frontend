    ...
    return (
      <>
        ...
        <div className='w-4/5 h-4/5 z-10 mx-auto mt-20 flex flex-col'>
          ...
          >
            <h1 className='text-2xl m-0 font-light'>Upload Job Description </h1>
          </div>
            ...
            <CRow>
              <CCol xs='auto'>
                <img
                  ...
                  style={
                    image
                      ? { width: '20vw', height: '15vw', visibility: 'visible' }
                      : { width: '0vw', height: '0vw', visibility: 'none' }
                  }
                  onClick={uploadImage}
                />
                <CButton
                  style={
                    image
                      ? { width: '0vw', height: '0vw', visibility: 'hidden' }
                      : { width: '20vw', height: '15vw', visibility: 'visible' }
                  }
                  onClick={uploadImage}
                >
              ...
              <CCol xs='auto'>
                <CRow>
                  <CCol xs='auto'>
                    <CFormLabel htmlFor='autoSizingInput'>
                      Organization
                    </CFormLabel>
                    <CFormInput
                      id='formOrganization'
                ...
                <CRow>
                  ...
                  <CCol xs='auto'>
                    <CFormLabel htmlFor='autoSizingSelect'>
                      Employment type
                    </CFormLabel>
                    <CFormSelect
                      id='formEmployment'
